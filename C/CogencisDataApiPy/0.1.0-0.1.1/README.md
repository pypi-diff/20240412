# Comparing `tmp/CogencisDataApiPy-0.1.0.tar.gz` & `tmp/CogencisDataApiPy-0.1.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "CogencisDataApiPy-0.1.0.tar", last modified: Fri Apr 12 13:08:16 2024, max compression
+gzip compressed data, was "CogencisDataApiPy-0.1.1.tar", last modified: Fri Apr 12 13:28:37 2024, max compression
```

## Comparing `CogencisDataApiPy-0.1.0.tar` & `CogencisDataApiPy-0.1.1.tar`

### file list

```diff
@@ -1,12 +1,14 @@
-drwxrwxrwx   0        0        0        0 2024-04-12 13:08:16.572200 CogencisDataApiPy-0.1.0/
-drwxrwxrwx   0        0        0        0 2024-04-12 13:08:16.562690 CogencisDataApiPy-0.1.0/CogencisDataApiPy.egg-info/
--rw-rw-rw-   0        0        0      570 2024-04-12 13:08:16.000000 CogencisDataApiPy-0.1.0/CogencisDataApiPy.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      234 2024-04-12 13:08:16.000000 CogencisDataApiPy-0.1.0/CogencisDataApiPy.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2024-04-12 13:08:16.000000 CogencisDataApiPy-0.1.0/CogencisDataApiPy.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0       16 2024-04-12 13:08:16.000000 CogencisDataApiPy-0.1.0/CogencisDataApiPy.egg-info/requires.txt
--rw-rw-rw-   0        0        0        1 2024-04-12 13:08:16.000000 CogencisDataApiPy-0.1.0/CogencisDataApiPy.egg-info/top_level.txt
--rw-rw-rw-   0        0        0       40 2024-04-12 04:00:23.000000 CogencisDataApiPy-0.1.0/MANIFEST.in
--rw-rw-rw-   0        0        0      570 2024-04-12 13:08:16.572200 CogencisDataApiPy-0.1.0/PKG-INFO
--rw-rw-rw-   0        0        0      121 2024-04-12 04:58:26.000000 CogencisDataApiPy-0.1.0/README.md
--rw-rw-rw-   0        0        0       42 2024-04-12 13:08:16.572200 CogencisDataApiPy-0.1.0/setup.cfg
--rw-rw-rw-   0        0        0      650 2024-04-12 13:07:57.000000 CogencisDataApiPy-0.1.0/setup.py
...
### Comparing `CogencisDataApiPy-0.1.0/CogencisDataApiPy.egg-info/PKG-INFO` & `CogencisDataApiPy-0.1.1/CogencisDataApiPy.egg-info/PKG-INFO`
...
### Comparing `CogencisDataApiPy-0.1.0/PKG-INFO` & `CogencisDataApiPy-0.1.1/PKG-INFO`
...
### Comparing `CogencisDataApiPy-0.1.0/setup.py` & `CogencisDataApiPy-0.1.1/setup.py`
