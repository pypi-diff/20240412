# Comparing `tmp/chiefgram-2.5.tar.gz` & `tmp/chiefgram-3.5.tar.gz`
...
### Comparing `chiefgram-2.5/README.md` & `chiefgram-3.5/README.md`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/__init__.py` & `chiefgram-3.5/chiefgram/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/chiefmod/__init__.py` & `chiefgram-3.5/chiefgram/chiefmod/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/chiefmod/helpers/__init__.py` & `chiefgram-3.5/chiefgram/chiefmod/helpers/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/chiefmod/helpers/helpers.py` & `chiefgram-3.5/chiefgram/chiefmod/helpers/helpers.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/chiefmod/listen/__init__.py` & `chiefgram-3.5/chiefgram/chiefmod/listen/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/chiefmod/listen/callback_query_handler.py` & `chiefgram-3.5/chiefgram/chiefmod/listen/callback_query_handler.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/chiefmod/listen/chat.py` & `chiefgram-3.5/chiefgram/chiefmod/listen/chat.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/chiefmod/listen/client.py` & `chiefgram-3.5/chiefgram/chiefmod/listen/client.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/chiefmod/listen/message.py` & `chiefgram-3.5/chiefgram/chiefmod/listen/message.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/chiefmod/listen/message_handler.py` & `chiefgram-3.5/chiefgram/chiefmod/listen/message_handler.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/chiefmod/listen/user.py` & `chiefgram-3.5/chiefgram/chiefmod/listen/user.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/chiefmod/nav/__init__.py` & `chiefgram-3.5/chiefgram/chiefmod/nav/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/chiefmod/nav/pagination.py` & `chiefgram-3.5/chiefgram/chiefmod/nav/pagination.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/chiefmod/types/identifier.py` & `chiefgram-3.5/chiefgram/chiefmod/types/identifier.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/chiefmod/utils/__init__.py` & `chiefgram-3.5/chiefgram/chiefmod/utils/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/chiefmod/utils/patch.py` & `chiefgram-3.5/chiefgram/chiefmod/utils/patch.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/client.py` & `chiefgram-3.5/chiefgram/client.py`
...
-            Defaults to 1.
     ...
     APP_VERSION = f"chiefgram {__version__}"
...
+            
     async def authorize(self) -> User:
         ...
         print(f"Welcome to chiefgram (version {__version__})")
         print(f"chiefgram is free software and comes with ABSOLUTELY NO WARRANTY. Licensed\n"
               f"under the terms of the {__license__}.\n")
```

### Comparing `chiefgram-2.5/chiefgram/connection/__init__.py` & `chiefgram-3.5/chiefgram/connection/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/connection/connection.py` & `chiefgram-3.5/chiefgram/connection/connection.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/connection/transport/__init__.py` & `chiefgram-3.5/chiefgram/connection/transport/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/connection/transport/tcp/__init__.py` & `chiefgram-3.5/chiefgram/connection/transport/tcp/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/connection/transport/tcp/tcp.py` & `chiefgram-3.5/chiefgram/connection/transport/tcp/tcp.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/connection/transport/tcp/tcp_abridged.py` & `chiefgram-3.5/chiefgram/connection/transport/tcp/tcp_abridged.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/connection/transport/tcp/tcp_abridged_o.py` & `chiefgram-3.5/chiefgram/connection/transport/tcp/tcp_abridged_o.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/connection/transport/tcp/tcp_full.py` & `chiefgram-3.5/chiefgram/connection/transport/tcp/tcp_full.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/connection/transport/tcp/tcp_intermediate.py` & `chiefgram-3.5/chiefgram/connection/transport/tcp/tcp_intermediate.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/connection/transport/tcp/tcp_intermediate_o.py` & `chiefgram-3.5/chiefgram/connection/transport/tcp/tcp_intermediate_o.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/crypto/__init__.py` & `chiefgram-3.5/chiefgram/crypto/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/crypto/aes.py` & `chiefgram-3.5/chiefgram/crypto/aes.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/crypto/mtproto.py` & `chiefgram-3.5/chiefgram/crypto/mtproto.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/crypto/prime.py` & `chiefgram-3.5/chiefgram/crypto/prime.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/crypto/rsa.py` & `chiefgram-3.5/chiefgram/crypto/rsa.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/dispatcher.py` & `chiefgram-3.5/chiefgram/dispatcher.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/emoji.py` & `chiefgram-3.5/chiefgram/emoji.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/enums/__init__.py` & `chiefgram-3.5/chiefgram/enums/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/enums/auto_name.py` & `chiefgram-3.5/chiefgram/enums/auto_name.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/enums/chat_action.py` & `chiefgram-3.5/chiefgram/enums/chat_action.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/enums/chat_event_action.py` & `chiefgram-3.5/chiefgram/enums/chat_event_action.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/enums/chat_member_status.py` & `chiefgram-3.5/chiefgram/enums/chat_member_status.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/enums/chat_members_filter.py` & `chiefgram-3.5/chiefgram/enums/chat_members_filter.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/enums/chat_type.py` & `chiefgram-3.5/chiefgram/enums/chat_type.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/enums/message_entity_type.py` & `chiefgram-3.5/chiefgram/enums/message_entity_type.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/enums/message_media_type.py` & `chiefgram-3.5/chiefgram/enums/message_media_type.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/enums/message_service_type.py` & `chiefgram-3.5/chiefgram/enums/message_service_type.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/enums/messages_filter.py` & `chiefgram-3.5/chiefgram/enums/messages_filter.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/enums/next_code_type.py` & `chiefgram-3.5/chiefgram/enums/next_code_type.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/enums/parse_mode.py` & `chiefgram-3.5/chiefgram/enums/parse_mode.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/enums/poll_type.py` & `chiefgram-3.5/chiefgram/enums/poll_type.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/enums/sent_code_type.py` & `chiefgram-3.5/chiefgram/enums/sent_code_type.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/enums/user_status.py` & `chiefgram-3.5/chiefgram/enums/user_status.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/errors/__init__.py` & `chiefgram-3.5/chiefgram/errors/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/errors/rpc_error.py` & `chiefgram-3.5/chiefgram/errors/rpc_error.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/file_id.py` & `chiefgram-3.5/chiefgram/file_id.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/filters.py` & `chiefgram-3.5/chiefgram/filters.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/handlers/__init__.py` & `chiefgram-3.5/chiefgram/handlers/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/handlers/callback_query_handler.py` & `chiefgram-3.5/chiefgram/handlers/callback_query_handler.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/handlers/chat_join_request_handler.py` & `chiefgram-3.5/chiefgram/handlers/chat_join_request_handler.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/handlers/chat_member_updated_handler.py` & `chiefgram-3.5/chiefgram/handlers/chat_member_updated_handler.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/handlers/chosen_inline_result_handler.py` & `chiefgram-3.5/chiefgram/handlers/chosen_inline_result_handler.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/handlers/deleted_messages_handler.py` & `chiefgram-3.5/chiefgram/handlers/deleted_messages_handler.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/handlers/disconnect_handler.py` & `chiefgram-3.5/chiefgram/handlers/disconnect_handler.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/handlers/edited_message_handler.py` & `chiefgram-3.5/chiefgram/handlers/edited_message_handler.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/handlers/handler.py` & `chiefgram-3.5/chiefgram/handlers/handler.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/handlers/inline_query_handler.py` & `chiefgram-3.5/chiefgram/handlers/inline_query_handler.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/handlers/message_handler.py` & `chiefgram-3.5/chiefgram/handlers/message_handler.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/handlers/poll_handler.py` & `chiefgram-3.5/chiefgram/handlers/poll_handler.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/handlers/raw_update_handler.py` & `chiefgram-3.5/chiefgram/handlers/raw_update_handler.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/handlers/user_status_handler.py` & `chiefgram-3.5/chiefgram/handlers/user_status_handler.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/__init__.py` & `chiefgram-3.5/chiefgram/methods/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/advanced/__init__.py` & `chiefgram-3.5/chiefgram/methods/advanced/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/advanced/invoke.py` & `chiefgram-3.5/chiefgram/methods/advanced/invoke.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/advanced/resolve_peer.py` & `chiefgram-3.5/chiefgram/methods/advanced/resolve_peer.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/advanced/save_file.py` & `chiefgram-3.5/chiefgram/methods/advanced/save_file.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/auth/__init__.py` & `chiefgram-3.5/chiefgram/methods/auth/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/auth/accept_terms_of_service.py` & `chiefgram-3.5/chiefgram/methods/auth/accept_terms_of_service.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/auth/check_password.py` & `chiefgram-3.5/chiefgram/methods/auth/check_password.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/auth/connect.py` & `chiefgram-3.5/chiefgram/methods/auth/connect.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/auth/disconnect.py` & `chiefgram-3.5/chiefgram/methods/auth/disconnect.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/auth/get_password_hint.py` & `chiefgram-3.5/chiefgram/methods/auth/get_password_hint.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/auth/initialize.py` & `chiefgram-3.5/chiefgram/methods/auth/initialize.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/auth/log_out.py` & `chiefgram-3.5/chiefgram/methods/auth/log_out.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/auth/recover_password.py` & `chiefgram-3.5/chiefgram/methods/auth/recover_password.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/auth/resend_code.py` & `chiefgram-3.5/chiefgram/methods/auth/resend_code.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/auth/send_code.py` & `chiefgram-3.5/chiefgram/methods/auth/send_code.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/auth/send_recovery_code.py` & `chiefgram-3.5/chiefgram/methods/auth/send_recovery_code.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/auth/sign_in.py` & `chiefgram-3.5/chiefgram/methods/auth/sign_in.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/auth/sign_in_bot.py` & `chiefgram-3.5/chiefgram/methods/auth/sign_in_bot.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/auth/sign_up.py` & `chiefgram-3.5/chiefgram/methods/auth/sign_up.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/auth/terminate.py` & `chiefgram-3.5/chiefgram/methods/auth/terminate.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/bots/__init__.py` & `chiefgram-3.5/chiefgram/methods/bots/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/bots/answer_callback_query.py` & `chiefgram-3.5/chiefgram/methods/bots/answer_callback_query.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/bots/answer_inline_query.py` & `chiefgram-3.5/chiefgram/methods/bots/answer_inline_query.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/bots/answer_web_app_query.py` & `chiefgram-3.5/chiefgram/methods/bots/answer_web_app_query.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/bots/delete_bot_commands.py` & `chiefgram-3.5/chiefgram/methods/bots/delete_bot_commands.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/bots/get_bot_commands.py` & `chiefgram-3.5/chiefgram/methods/bots/get_bot_commands.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/bots/get_bot_default_privileges.py` & `chiefgram-3.5/chiefgram/methods/bots/get_bot_default_privileges.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/bots/get_chat_menu_button.py` & `chiefgram-3.5/chiefgram/methods/bots/get_chat_menu_button.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/bots/get_game_high_scores.py` & `chiefgram-3.5/chiefgram/methods/bots/get_game_high_scores.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/bots/get_inline_bot_results.py` & `chiefgram-3.5/chiefgram/methods/bots/get_inline_bot_results.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/bots/request_callback_answer.py` & `chiefgram-3.5/chiefgram/methods/bots/request_callback_answer.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/bots/send_game.py` & `chiefgram-3.5/chiefgram/methods/bots/send_game.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/bots/send_inline_bot_result.py` & `chiefgram-3.5/chiefgram/methods/bots/send_inline_bot_result.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/bots/set_bot_commands.py` & `chiefgram-3.5/chiefgram/methods/bots/set_bot_commands.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/bots/set_bot_default_privileges.py` & `chiefgram-3.5/chiefgram/methods/bots/set_bot_default_privileges.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/bots/set_chat_menu_button.py` & `chiefgram-3.5/chiefgram/methods/bots/set_chat_menu_button.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/bots/set_game_score.py` & `chiefgram-3.5/chiefgram/methods/bots/set_game_score.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/__init__.py` & `chiefgram-3.5/chiefgram/methods/chats/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/add_chat_members.py` & `chiefgram-3.5/chiefgram/methods/chats/add_chat_members.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/archive_chats.py` & `chiefgram-3.5/chiefgram/methods/chats/archive_chats.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/ban_chat_member.py` & `chiefgram-3.5/chiefgram/methods/chats/ban_chat_member.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/create_channel.py` & `chiefgram-3.5/chiefgram/methods/chats/create_channel.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/create_group.py` & `chiefgram-3.5/chiefgram/methods/chats/create_group.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/create_supergroup.py` & `chiefgram-3.5/chiefgram/methods/chats/create_supergroup.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/delete_channel.py` & `chiefgram-3.5/chiefgram/methods/chats/delete_channel.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/delete_chat_photo.py` & `chiefgram-3.5/chiefgram/methods/chats/delete_chat_photo.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/delete_supergroup.py` & `chiefgram-3.5/chiefgram/methods/chats/delete_supergroup.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/delete_user_history.py` & `chiefgram-3.5/chiefgram/methods/chats/delete_user_history.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/get_chat.py` & `chiefgram-3.5/chiefgram/methods/chats/get_chat.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/get_chat_event_log.py` & `chiefgram-3.5/chiefgram/methods/chats/get_chat_event_log.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/get_chat_member.py` & `chiefgram-3.5/chiefgram/methods/chats/get_chat_member.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/get_chat_members.py` & `chiefgram-3.5/chiefgram/methods/chats/get_chat_members.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/get_chat_members_count.py` & `chiefgram-3.5/chiefgram/methods/chats/get_chat_members_count.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/get_chat_online_count.py` & `chiefgram-3.5/chiefgram/methods/chats/get_chat_online_count.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/get_dialogs.py` & `chiefgram-3.5/chiefgram/methods/chats/get_dialogs.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/get_dialogs_count.py` & `chiefgram-3.5/chiefgram/methods/chats/get_dialogs_count.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/get_nearby_chats.py` & `chiefgram-3.5/chiefgram/methods/chats/get_nearby_chats.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/get_send_as_chats.py` & `chiefgram-3.5/chiefgram/methods/chats/get_send_as_chats.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/join_chat.py` & `chiefgram-3.5/chiefgram/methods/chats/join_chat.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/leave_chat.py` & `chiefgram-3.5/chiefgram/methods/chats/leave_chat.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/mark_chat_unread.py` & `chiefgram-3.5/chiefgram/methods/chats/mark_chat_unread.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/pin_chat_message.py` & `chiefgram-3.5/chiefgram/methods/chats/pin_chat_message.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/promote_chat_member.py` & `chiefgram-3.5/chiefgram/methods/chats/promote_chat_member.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/restrict_chat_member.py` & `chiefgram-3.5/chiefgram/methods/chats/restrict_chat_member.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/set_administrator_title.py` & `chiefgram-3.5/chiefgram/methods/chats/set_administrator_title.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/set_chat_description.py` & `chiefgram-3.5/chiefgram/methods/chats/set_chat_description.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/set_chat_permissions.py` & `chiefgram-3.5/chiefgram/methods/chats/set_chat_permissions.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/set_chat_photo.py` & `chiefgram-3.5/chiefgram/methods/chats/set_chat_photo.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/set_chat_protected_content.py` & `chiefgram-3.5/chiefgram/methods/chats/set_chat_protected_content.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/set_chat_title.py` & `chiefgram-3.5/chiefgram/methods/chats/set_chat_title.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/set_chat_username.py` & `chiefgram-3.5/chiefgram/methods/chats/set_chat_username.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/set_send_as_chat.py` & `chiefgram-3.5/chiefgram/methods/chats/set_send_as_chat.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/set_slow_mode.py` & `chiefgram-3.5/chiefgram/methods/chats/set_slow_mode.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/unarchive_chats.py` & `chiefgram-3.5/chiefgram/methods/chats/unarchive_chats.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/unban_chat_member.py` & `chiefgram-3.5/chiefgram/methods/chats/unban_chat_member.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/unpin_all_chat_messages.py` & `chiefgram-3.5/chiefgram/methods/chats/unpin_all_chat_messages.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/chats/unpin_chat_message.py` & `chiefgram-3.5/chiefgram/methods/chats/unpin_chat_message.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/contacts/__init__.py` & `chiefgram-3.5/chiefgram/methods/contacts/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/contacts/add_contact.py` & `chiefgram-3.5/chiefgram/methods/contacts/add_contact.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/contacts/delete_contacts.py` & `chiefgram-3.5/chiefgram/methods/contacts/delete_contacts.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/contacts/get_contacts.py` & `chiefgram-3.5/chiefgram/methods/contacts/get_contacts.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/contacts/get_contacts_count.py` & `chiefgram-3.5/chiefgram/methods/contacts/get_contacts_count.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/contacts/import_contacts.py` & `chiefgram-3.5/chiefgram/methods/contacts/import_contacts.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/decorators/__init__.py` & `chiefgram-3.5/chiefgram/methods/decorators/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/decorators/on_callback_query.py` & `chiefgram-3.5/chiefgram/methods/decorators/on_callback_query.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/decorators/on_chat_join_request.py` & `chiefgram-3.5/chiefgram/methods/decorators/on_chat_join_request.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/decorators/on_chat_member_updated.py` & `chiefgram-3.5/chiefgram/methods/decorators/on_chat_member_updated.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/decorators/on_chosen_inline_result.py` & `chiefgram-3.5/chiefgram/methods/decorators/on_chosen_inline_result.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/decorators/on_deleted_messages.py` & `chiefgram-3.5/chiefgram/methods/decorators/on_deleted_messages.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/decorators/on_disconnect.py` & `chiefgram-3.5/chiefgram/methods/decorators/on_disconnect.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/decorators/on_edited_message.py` & `chiefgram-3.5/chiefgram/methods/decorators/on_edited_message.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/decorators/on_inline_query.py` & `chiefgram-3.5/chiefgram/methods/decorators/on_inline_query.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/decorators/on_message.py` & `chiefgram-3.5/chiefgram/methods/decorators/on_message.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/decorators/on_poll.py` & `chiefgram-3.5/chiefgram/methods/decorators/on_poll.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/decorators/on_raw_update.py` & `chiefgram-3.5/chiefgram/methods/decorators/on_raw_update.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/decorators/on_user_status.py` & `chiefgram-3.5/chiefgram/methods/decorators/on_user_status.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/invite_links/__init__.py` & `chiefgram-3.5/chiefgram/methods/invite_links/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/invite_links/approve_all_chat_join_requests.py` & `chiefgram-3.5/chiefgram/methods/invite_links/approve_all_chat_join_requests.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/invite_links/approve_chat_join_request.py` & `chiefgram-3.5/chiefgram/methods/invite_links/approve_chat_join_request.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/invite_links/create_chat_invite_link.py` & `chiefgram-3.5/chiefgram/methods/invite_links/create_chat_invite_link.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/invite_links/decline_all_chat_join_requests.py` & `chiefgram-3.5/chiefgram/methods/invite_links/decline_all_chat_join_requests.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/invite_links/decline_chat_join_request.py` & `chiefgram-3.5/chiefgram/methods/invite_links/decline_chat_join_request.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/invite_links/delete_chat_admin_invite_links.py` & `chiefgram-3.5/chiefgram/methods/invite_links/delete_chat_admin_invite_links.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/invite_links/delete_chat_invite_link.py` & `chiefgram-3.5/chiefgram/methods/invite_links/delete_chat_invite_link.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/invite_links/edit_chat_invite_link.py` & `chiefgram-3.5/chiefgram/methods/invite_links/edit_chat_invite_link.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/invite_links/export_chat_invite_link.py` & `chiefgram-3.5/chiefgram/methods/invite_links/export_chat_invite_link.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/invite_links/get_chat_admin_invite_links.py` & `chiefgram-3.5/chiefgram/methods/invite_links/get_chat_admin_invite_links.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/invite_links/get_chat_admin_invite_links_count.py` & `chiefgram-3.5/chiefgram/methods/invite_links/get_chat_admin_invite_links_count.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/invite_links/get_chat_admins_with_invite_links.py` & `chiefgram-3.5/chiefgram/methods/invite_links/get_chat_admins_with_invite_links.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/invite_links/get_chat_invite_link.py` & `chiefgram-3.5/chiefgram/methods/invite_links/get_chat_invite_link.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/invite_links/get_chat_invite_link_joiners.py` & `chiefgram-3.5/chiefgram/methods/invite_links/get_chat_invite_link_joiners.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/invite_links/get_chat_invite_link_joiners_count.py` & `chiefgram-3.5/chiefgram/methods/invite_links/get_chat_invite_link_joiners_count.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/invite_links/get_chat_join_requests.py` & `chiefgram-3.5/chiefgram/methods/invite_links/get_chat_join_requests.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/invite_links/revoke_chat_invite_link.py` & `chiefgram-3.5/chiefgram/methods/invite_links/revoke_chat_invite_link.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/__init__.py` & `chiefgram-3.5/chiefgram/methods/messages/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/copy_media_group.py` & `chiefgram-3.5/chiefgram/methods/messages/copy_media_group.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/copy_message.py` & `chiefgram-3.5/chiefgram/methods/messages/copy_message.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/delete_messages.py` & `chiefgram-3.5/chiefgram/methods/messages/delete_messages.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/download_media.py` & `chiefgram-3.5/chiefgram/methods/messages/download_media.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/edit_inline_caption.py` & `chiefgram-3.5/chiefgram/methods/messages/edit_inline_caption.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/edit_inline_media.py` & `chiefgram-3.5/chiefgram/methods/messages/edit_inline_media.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/edit_inline_reply_markup.py` & `chiefgram-3.5/chiefgram/methods/messages/edit_inline_reply_markup.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/edit_inline_text.py` & `chiefgram-3.5/chiefgram/methods/messages/edit_inline_text.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/edit_message_caption.py` & `chiefgram-3.5/chiefgram/methods/messages/edit_message_caption.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/edit_message_media.py` & `chiefgram-3.5/chiefgram/methods/messages/edit_message_media.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/edit_message_reply_markup.py` & `chiefgram-3.5/chiefgram/methods/messages/edit_message_reply_markup.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/edit_message_text.py` & `chiefgram-3.5/chiefgram/methods/messages/edit_message_text.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/forward_messages.py` & `chiefgram-3.5/chiefgram/methods/messages/forward_messages.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/get_chat_history.py` & `chiefgram-3.5/chiefgram/methods/messages/get_chat_history.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/get_chat_history_count.py` & `chiefgram-3.5/chiefgram/methods/messages/get_chat_history_count.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/get_custom_emoji_stickers.py` & `chiefgram-3.5/chiefgram/methods/messages/get_custom_emoji_stickers.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/get_discussion_message.py` & `chiefgram-3.5/chiefgram/methods/messages/get_discussion_message.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/get_discussion_replies.py` & `chiefgram-3.5/chiefgram/methods/messages/get_discussion_replies.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/get_discussion_replies_count.py` & `chiefgram-3.5/chiefgram/methods/messages/get_discussion_replies_count.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/get_media_group.py` & `chiefgram-3.5/chiefgram/methods/messages/get_media_group.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/get_messages.py` & `chiefgram-3.5/chiefgram/methods/messages/get_messages.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/inline_session.py` & `chiefgram-3.5/chiefgram/methods/messages/inline_session.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/read_chat_history.py` & `chiefgram-3.5/chiefgram/methods/messages/read_chat_history.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/retract_vote.py` & `chiefgram-3.5/chiefgram/methods/messages/retract_vote.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/search_global.py` & `chiefgram-3.5/chiefgram/methods/messages/search_global.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/search_global_count.py` & `chiefgram-3.5/chiefgram/methods/messages/search_global_count.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/search_messages.py` & `chiefgram-3.5/chiefgram/methods/messages/search_messages.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/search_messages_count.py` & `chiefgram-3.5/chiefgram/methods/messages/search_messages_count.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/send_animation.py` & `chiefgram-3.5/chiefgram/methods/messages/send_animation.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/send_audio.py` & `chiefgram-3.5/chiefgram/methods/messages/send_audio.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/send_cached_media.py` & `chiefgram-3.5/chiefgram/methods/messages/send_cached_media.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/send_chat_action.py` & `chiefgram-3.5/chiefgram/methods/messages/send_chat_action.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/send_contact.py` & `chiefgram-3.5/chiefgram/methods/messages/send_contact.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/send_dice.py` & `chiefgram-3.5/chiefgram/methods/messages/send_dice.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/send_document.py` & `chiefgram-3.5/chiefgram/methods/messages/send_document.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/send_location.py` & `chiefgram-3.5/chiefgram/methods/messages/send_location.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/send_media_group.py` & `chiefgram-3.5/chiefgram/methods/messages/send_media_group.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/send_message.py` & `chiefgram-3.5/chiefgram/methods/messages/send_message.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/send_photo.py` & `chiefgram-3.5/chiefgram/methods/messages/send_photo.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/send_poll.py` & `chiefgram-3.5/chiefgram/methods/messages/send_poll.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/send_reaction.py` & `chiefgram-3.5/chiefgram/methods/messages/send_reaction.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/send_sticker.py` & `chiefgram-3.5/chiefgram/methods/messages/send_sticker.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/send_venue.py` & `chiefgram-3.5/chiefgram/methods/messages/send_venue.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/send_video.py` & `chiefgram-3.5/chiefgram/methods/messages/send_video.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/send_video_note.py` & `chiefgram-3.5/chiefgram/methods/messages/send_video_note.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/send_voice.py` & `chiefgram-3.5/chiefgram/methods/messages/send_voice.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/stop_poll.py` & `chiefgram-3.5/chiefgram/methods/messages/stop_poll.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/stream_media.py` & `chiefgram-3.5/chiefgram/methods/messages/stream_media.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/messages/vote_poll.py` & `chiefgram-3.5/chiefgram/methods/messages/vote_poll.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/password/__init__.py` & `chiefgram-3.5/chiefgram/methods/password/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/password/change_cloud_password.py` & `chiefgram-3.5/chiefgram/methods/password/change_cloud_password.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/password/enable_cloud_password.py` & `chiefgram-3.5/chiefgram/methods/password/enable_cloud_password.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/password/remove_cloud_password.py` & `chiefgram-3.5/chiefgram/methods/password/remove_cloud_password.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/users/__init__.py` & `chiefgram-3.5/chiefgram/methods/users/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/users/block_user.py` & `chiefgram-3.5/chiefgram/methods/users/block_user.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/users/delete_profile_photos.py` & `chiefgram-3.5/chiefgram/methods/users/delete_profile_photos.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/users/get_chat_photos.py` & `chiefgram-3.5/chiefgram/methods/users/get_chat_photos.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/users/get_chat_photos_count.py` & `chiefgram-3.5/chiefgram/methods/users/get_chat_photos_count.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/users/get_common_chats.py` & `chiefgram-3.5/chiefgram/methods/users/get_common_chats.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/users/get_default_emoji_statuses.py` & `chiefgram-3.5/chiefgram/methods/users/get_default_emoji_statuses.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/users/get_me.py` & `chiefgram-3.5/chiefgram/methods/users/get_me.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/users/get_users.py` & `chiefgram-3.5/chiefgram/methods/users/get_users.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/users/set_emoji_status.py` & `chiefgram-3.5/chiefgram/methods/users/set_emoji_status.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/users/set_profile_photo.py` & `chiefgram-3.5/chiefgram/methods/users/set_profile_photo.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/users/set_username.py` & `chiefgram-3.5/chiefgram/methods/users/set_username.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/users/unblock_user.py` & `chiefgram-3.5/chiefgram/methods/users/unblock_user.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/users/update_profile.py` & `chiefgram-3.5/chiefgram/methods/users/update_profile.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/utilities/__init__.py` & `chiefgram-3.5/chiefgram/methods/utilities/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/utilities/add_handler.py` & `chiefgram-3.5/chiefgram/methods/utilities/add_handler.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/utilities/compose.py` & `chiefgram-3.5/chiefgram/methods/utilities/compose.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/utilities/export_session_string.py` & `chiefgram-3.5/chiefgram/methods/utilities/export_session_string.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/utilities/idle.py` & `chiefgram-3.5/chiefgram/methods/utilities/idle.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/utilities/remove_handler.py` & `chiefgram-3.5/chiefgram/methods/utilities/remove_handler.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/utilities/restart.py` & `chiefgram-3.5/chiefgram/methods/utilities/restart.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/utilities/run.py` & `chiefgram-3.5/chiefgram/methods/utilities/run.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/utilities/start.py` & `chiefgram-3.5/chiefgram/methods/utilities/start.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/utilities/stop.py` & `chiefgram-3.5/chiefgram/methods/utilities/stop.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/methods/utilities/stop_transmission.py` & `chiefgram-3.5/chiefgram/methods/utilities/stop_transmission.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/mime_types.py` & `chiefgram-3.5/chiefgram/mime_types.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/parser/__init__.py` & `chiefgram-3.5/chiefgram/parser/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/parser/html.py` & `chiefgram-3.5/chiefgram/parser/html.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/parser/markdown.py` & `chiefgram-3.5/chiefgram/parser/markdown.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/parser/parser.py` & `chiefgram-3.5/chiefgram/parser/parser.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/parser/utils.py` & `chiefgram-3.5/chiefgram/parser/utils.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/raw/__init__.py` & `chiefgram-3.5/chiefgram/raw/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/raw/core/__init__.py` & `chiefgram-3.5/chiefgram/raw/core/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/raw/core/future_salt.py` & `chiefgram-3.5/chiefgram/raw/core/future_salt.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/raw/core/future_salts.py` & `chiefgram-3.5/chiefgram/raw/core/future_salts.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/raw/core/gzip_packed.py` & `chiefgram-3.5/chiefgram/raw/core/gzip_packed.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/raw/core/list.py` & `chiefgram-3.5/chiefgram/raw/core/list.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/raw/core/message.py` & `chiefgram-3.5/chiefgram/raw/core/message.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/raw/core/msg_container.py` & `chiefgram-3.5/chiefgram/raw/core/msg_container.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/raw/core/primitives/__init__.py` & `chiefgram-3.5/chiefgram/raw/core/primitives/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/raw/core/primitives/bool.py` & `chiefgram-3.5/chiefgram/raw/core/primitives/bool.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/raw/core/primitives/bytes.py` & `chiefgram-3.5/chiefgram/raw/core/primitives/bytes.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/raw/core/primitives/double.py` & `chiefgram-3.5/chiefgram/raw/core/primitives/double.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/raw/core/primitives/int.py` & `chiefgram-3.5/chiefgram/raw/core/primitives/int.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/raw/core/primitives/string.py` & `chiefgram-3.5/chiefgram/raw/core/primitives/string.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/raw/core/primitives/vector.py` & `chiefgram-3.5/chiefgram/raw/core/primitives/vector.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/raw/core/tl_object.py` & `chiefgram-3.5/chiefgram/raw/core/tl_object.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/session/__init__.py` & `chiefgram-3.5/chiefgram/session/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/session/auth.py` & `chiefgram-3.5/chiefgram/session/auth.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/session/internals/__init__.py` & `chiefgram-3.5/chiefgram/session/internals/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/session/internals/data_center.py` & `chiefgram-3.5/chiefgram/session/internals/data_center.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/session/internals/msg_factory.py` & `chiefgram-3.5/chiefgram/session/internals/msg_factory.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/session/internals/msg_id.py` & `chiefgram-3.5/chiefgram/session/internals/msg_id.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/session/internals/seq_no.py` & `chiefgram-3.5/chiefgram/session/internals/seq_no.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/session/session.py` & `chiefgram-3.5/chiefgram/session/session.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/storage/__init__.py` & `chiefgram-3.5/chiefgram/storage/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/storage/file_storage.py` & `chiefgram-3.5/chiefgram/storage/file_storage.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/storage/memory_storage.py` & `chiefgram-3.5/chiefgram/storage/memory_storage.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/storage/sqlite_storage.py` & `chiefgram-3.5/chiefgram/storage/sqlite_storage.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/storage/storage.py` & `chiefgram-3.5/chiefgram/storage/storage.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/sync.py` & `chiefgram-3.5/chiefgram/sync.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/__init__.py` & `chiefgram-3.5/chiefgram/types/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/authorization/__init__.py` & `chiefgram-3.5/chiefgram/types/authorization/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/authorization/sent_code.py` & `chiefgram-3.5/chiefgram/types/authorization/sent_code.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/authorization/terms_of_service.py` & `chiefgram-3.5/chiefgram/types/authorization/terms_of_service.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/bots_and_keyboards/__init__.py` & `chiefgram-3.5/chiefgram/types/bots_and_keyboards/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/bots_and_keyboards/bot_command.py` & `chiefgram-3.5/chiefgram/types/bots_and_keyboards/bot_command.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/bots_and_keyboards/bot_command_scope.py` & `chiefgram-3.5/chiefgram/types/bots_and_keyboards/bot_command_scope.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/bots_and_keyboards/bot_command_scope_all_chat_administrators.py` & `chiefgram-3.5/chiefgram/types/bots_and_keyboards/bot_command_scope_all_chat_administrators.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/bots_and_keyboards/bot_command_scope_all_group_chats.py` & `chiefgram-3.5/chiefgram/types/bots_and_keyboards/bot_command_scope_all_group_chats.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/bots_and_keyboards/bot_command_scope_all_private_chats.py` & `chiefgram-3.5/chiefgram/types/bots_and_keyboards/bot_command_scope_all_private_chats.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/bots_and_keyboards/bot_command_scope_chat.py` & `chiefgram-3.5/chiefgram/types/bots_and_keyboards/bot_command_scope_chat.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/bots_and_keyboards/bot_command_scope_chat_administrators.py` & `chiefgram-3.5/chiefgram/types/bots_and_keyboards/bot_command_scope_chat_administrators.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/bots_and_keyboards/bot_command_scope_chat_member.py` & `chiefgram-3.5/chiefgram/types/bots_and_keyboards/bot_command_scope_chat_member.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/bots_and_keyboards/bot_command_scope_default.py` & `chiefgram-3.5/chiefgram/types/bots_and_keyboards/bot_command_scope_default.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/bots_and_keyboards/callback_game.py` & `chiefgram-3.5/chiefgram/types/bots_and_keyboards/callback_game.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/bots_and_keyboards/callback_query.py` & `chiefgram-3.5/chiefgram/types/bots_and_keyboards/callback_query.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/bots_and_keyboards/force_reply.py` & `chiefgram-3.5/chiefgram/types/bots_and_keyboards/force_reply.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/bots_and_keyboards/game_high_score.py` & `chiefgram-3.5/chiefgram/types/bots_and_keyboards/game_high_score.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/bots_and_keyboards/inline_keyboard_button.py` & `chiefgram-3.5/chiefgram/types/bots_and_keyboards/inline_keyboard_button.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/bots_and_keyboards/inline_keyboard_markup.py` & `chiefgram-3.5/chiefgram/types/bots_and_keyboards/inline_keyboard_markup.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/bots_and_keyboards/keyboard_button.py` & `chiefgram-3.5/chiefgram/types/bots_and_keyboards/keyboard_button.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/bots_and_keyboards/login_url.py` & `chiefgram-3.5/chiefgram/types/bots_and_keyboards/login_url.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/bots_and_keyboards/menu_button.py` & `chiefgram-3.5/chiefgram/types/bots_and_keyboards/menu_button.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/bots_and_keyboards/menu_button_commands.py` & `chiefgram-3.5/chiefgram/types/bots_and_keyboards/menu_button_commands.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/bots_and_keyboards/menu_button_default.py` & `chiefgram-3.5/chiefgram/types/bots_and_keyboards/menu_button_default.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/bots_and_keyboards/menu_button_web_app.py` & `chiefgram-3.5/chiefgram/types/bots_and_keyboards/menu_button_web_app.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/bots_and_keyboards/reply_keyboard_markup.py` & `chiefgram-3.5/chiefgram/types/bots_and_keyboards/reply_keyboard_markup.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/bots_and_keyboards/reply_keyboard_remove.py` & `chiefgram-3.5/chiefgram/types/bots_and_keyboards/reply_keyboard_remove.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/bots_and_keyboards/sent_web_app_message.py` & `chiefgram-3.5/chiefgram/types/bots_and_keyboards/sent_web_app_message.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/bots_and_keyboards/web_app_info.py` & `chiefgram-3.5/chiefgram/types/bots_and_keyboards/web_app_info.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/inline_mode/__init__.py` & `chiefgram-3.5/chiefgram/types/inline_mode/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/inline_mode/chosen_inline_result.py` & `chiefgram-3.5/chiefgram/types/inline_mode/chosen_inline_result.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/inline_mode/inline_query.py` & `chiefgram-3.5/chiefgram/types/inline_mode/inline_query.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/inline_mode/inline_query_result.py` & `chiefgram-3.5/chiefgram/types/inline_mode/inline_query_result.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/inline_mode/inline_query_result_animation.py` & `chiefgram-3.5/chiefgram/types/inline_mode/inline_query_result_animation.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/inline_mode/inline_query_result_article.py` & `chiefgram-3.5/chiefgram/types/inline_mode/inline_query_result_article.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/inline_mode/inline_query_result_audio.py` & `chiefgram-3.5/chiefgram/types/inline_mode/inline_query_result_audio.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/inline_mode/inline_query_result_cached_animation.py` & `chiefgram-3.5/chiefgram/types/inline_mode/inline_query_result_cached_animation.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/inline_mode/inline_query_result_cached_audio.py` & `chiefgram-3.5/chiefgram/types/inline_mode/inline_query_result_cached_audio.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/inline_mode/inline_query_result_cached_document.py` & `chiefgram-3.5/chiefgram/types/inline_mode/inline_query_result_cached_document.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/inline_mode/inline_query_result_cached_photo.py` & `chiefgram-3.5/chiefgram/types/inline_mode/inline_query_result_cached_photo.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/inline_mode/inline_query_result_cached_sticker.py` & `chiefgram-3.5/chiefgram/types/inline_mode/inline_query_result_cached_sticker.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/inline_mode/inline_query_result_cached_video.py` & `chiefgram-3.5/chiefgram/types/inline_mode/inline_query_result_cached_video.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/inline_mode/inline_query_result_cached_voice.py` & `chiefgram-3.5/chiefgram/types/inline_mode/inline_query_result_cached_voice.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/inline_mode/inline_query_result_contact.py` & `chiefgram-3.5/chiefgram/types/inline_mode/inline_query_result_contact.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/inline_mode/inline_query_result_document.py` & `chiefgram-3.5/chiefgram/types/inline_mode/inline_query_result_document.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/inline_mode/inline_query_result_location.py` & `chiefgram-3.5/chiefgram/types/inline_mode/inline_query_result_location.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/inline_mode/inline_query_result_photo.py` & `chiefgram-3.5/chiefgram/types/inline_mode/inline_query_result_photo.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/inline_mode/inline_query_result_venue.py` & `chiefgram-3.5/chiefgram/types/inline_mode/inline_query_result_venue.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/inline_mode/inline_query_result_video.py` & `chiefgram-3.5/chiefgram/types/inline_mode/inline_query_result_video.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/inline_mode/inline_query_result_voice.py` & `chiefgram-3.5/chiefgram/types/inline_mode/inline_query_result_voice.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/input_media/__init__.py` & `chiefgram-3.5/chiefgram/types/input_media/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/input_media/input_media.py` & `chiefgram-3.5/chiefgram/types/input_media/input_media.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/input_media/input_media_animation.py` & `chiefgram-3.5/chiefgram/types/input_media/input_media_animation.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/input_media/input_media_audio.py` & `chiefgram-3.5/chiefgram/types/input_media/input_media_audio.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/input_media/input_media_document.py` & `chiefgram-3.5/chiefgram/types/input_media/input_media_document.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/input_media/input_media_photo.py` & `chiefgram-3.5/chiefgram/types/input_media/input_media_photo.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/input_media/input_media_video.py` & `chiefgram-3.5/chiefgram/types/input_media/input_media_video.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/input_media/input_phone_contact.py` & `chiefgram-3.5/chiefgram/types/input_media/input_phone_contact.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/input_message_content/__init__.py` & `chiefgram-3.5/chiefgram/types/input_message_content/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/input_message_content/input_message_content.py` & `chiefgram-3.5/chiefgram/types/input_message_content/input_message_content.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/input_message_content/input_text_message_content.py` & `chiefgram-3.5/chiefgram/types/input_message_content/input_text_message_content.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/list.py` & `chiefgram-3.5/chiefgram/types/list.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/messages_and_media/__init__.py` & `chiefgram-3.5/chiefgram/types/messages_and_media/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/messages_and_media/animation.py` & `chiefgram-3.5/chiefgram/types/messages_and_media/animation.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/messages_and_media/audio.py` & `chiefgram-3.5/chiefgram/types/messages_and_media/audio.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/messages_and_media/contact.py` & `chiefgram-3.5/chiefgram/types/messages_and_media/contact.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/messages_and_media/dice.py` & `chiefgram-3.5/chiefgram/types/messages_and_media/dice.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/messages_and_media/document.py` & `chiefgram-3.5/chiefgram/types/messages_and_media/document.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/messages_and_media/game.py` & `chiefgram-3.5/chiefgram/types/messages_and_media/game.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/messages_and_media/location.py` & `chiefgram-3.5/chiefgram/types/messages_and_media/location.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/messages_and_media/message.py` & `chiefgram-3.5/chiefgram/types/messages_and_media/message.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/messages_and_media/message_entity.py` & `chiefgram-3.5/chiefgram/types/messages_and_media/message_entity.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/messages_and_media/message_reactions.py` & `chiefgram-3.5/chiefgram/types/messages_and_media/message_reactions.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/messages_and_media/photo.py` & `chiefgram-3.5/chiefgram/types/messages_and_media/photo.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/messages_and_media/poll.py` & `chiefgram-3.5/chiefgram/types/messages_and_media/poll.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/messages_and_media/poll_option.py` & `chiefgram-3.5/chiefgram/types/messages_and_media/poll_option.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/messages_and_media/reaction.py` & `chiefgram-3.5/chiefgram/types/messages_and_media/reaction.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/messages_and_media/sticker.py` & `chiefgram-3.5/chiefgram/types/messages_and_media/sticker.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/messages_and_media/stripped_thumbnail.py` & `chiefgram-3.5/chiefgram/types/messages_and_media/stripped_thumbnail.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/messages_and_media/thumbnail.py` & `chiefgram-3.5/chiefgram/types/messages_and_media/thumbnail.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/messages_and_media/venue.py` & `chiefgram-3.5/chiefgram/types/messages_and_media/venue.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/messages_and_media/video.py` & `chiefgram-3.5/chiefgram/types/messages_and_media/video.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/messages_and_media/video_note.py` & `chiefgram-3.5/chiefgram/types/messages_and_media/video_note.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/messages_and_media/voice.py` & `chiefgram-3.5/chiefgram/types/messages_and_media/voice.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/messages_and_media/web_app_data.py` & `chiefgram-3.5/chiefgram/types/messages_and_media/web_app_data.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/messages_and_media/web_page.py` & `chiefgram-3.5/chiefgram/types/messages_and_media/web_page.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/object.py` & `chiefgram-3.5/chiefgram/types/object.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/update.py` & `chiefgram-3.5/chiefgram/types/update.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/user_and_chats/__init__.py` & `chiefgram-3.5/chiefgram/types/user_and_chats/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/user_and_chats/chat.py` & `chiefgram-3.5/chiefgram/types/user_and_chats/chat.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/user_and_chats/chat_admin_with_invite_links.py` & `chiefgram-3.5/chiefgram/types/user_and_chats/chat_admin_with_invite_links.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/user_and_chats/chat_event.py` & `chiefgram-3.5/chiefgram/types/user_and_chats/chat_event.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/user_and_chats/chat_event_filter.py` & `chiefgram-3.5/chiefgram/types/user_and_chats/chat_event_filter.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/user_and_chats/chat_invite_link.py` & `chiefgram-3.5/chiefgram/types/user_and_chats/chat_invite_link.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/user_and_chats/chat_join_request.py` & `chiefgram-3.5/chiefgram/types/user_and_chats/chat_join_request.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/user_and_chats/chat_joiner.py` & `chiefgram-3.5/chiefgram/types/user_and_chats/chat_joiner.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/user_and_chats/chat_member.py` & `chiefgram-3.5/chiefgram/types/user_and_chats/chat_member.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/user_and_chats/chat_member_updated.py` & `chiefgram-3.5/chiefgram/types/user_and_chats/chat_member_updated.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/user_and_chats/chat_permissions.py` & `chiefgram-3.5/chiefgram/types/user_and_chats/chat_permissions.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/user_and_chats/chat_photo.py` & `chiefgram-3.5/chiefgram/types/user_and_chats/chat_photo.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/user_and_chats/chat_preview.py` & `chiefgram-3.5/chiefgram/types/user_and_chats/chat_preview.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/user_and_chats/chat_privileges.py` & `chiefgram-3.5/chiefgram/types/user_and_chats/chat_privileges.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/user_and_chats/chat_reactions.py` & `chiefgram-3.5/chiefgram/types/user_and_chats/chat_reactions.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/user_and_chats/dialog.py` & `chiefgram-3.5/chiefgram/types/user_and_chats/dialog.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/user_and_chats/emoji_status.py` & `chiefgram-3.5/chiefgram/types/user_and_chats/emoji_status.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/user_and_chats/invite_link_importer.py` & `chiefgram-3.5/chiefgram/types/user_and_chats/invite_link_importer.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/user_and_chats/restriction.py` & `chiefgram-3.5/chiefgram/types/user_and_chats/restriction.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/user_and_chats/user.py` & `chiefgram-3.5/chiefgram/types/user_and_chats/user.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/user_and_chats/video_chat_ended.py` & `chiefgram-3.5/chiefgram/types/user_and_chats/video_chat_ended.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/user_and_chats/video_chat_members_invited.py` & `chiefgram-3.5/chiefgram/types/user_and_chats/video_chat_members_invited.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/user_and_chats/video_chat_scheduled.py` & `chiefgram-3.5/chiefgram/types/user_and_chats/video_chat_scheduled.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/types/user_and_chats/video_chat_started.py` & `chiefgram-3.5/chiefgram/types/user_and_chats/video_chat_started.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram/utils.py` & `chiefgram-3.5/chiefgram/utils.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/chiefgram.egg-info/SOURCES.txt` & `chiefgram-3.5/chiefgram.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/compiler/__init__.py` & `chiefgram-3.5/compiler/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/compiler/api/__init__.py` & `chiefgram-3.5/compiler/api/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/compiler/api/compiler.py` & `chiefgram-3.5/compiler/api/compiler.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/compiler/api/source/auth_key.tl` & `chiefgram-3.5/compiler/api/source/auth_key.tl`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/compiler/api/source/main_api.tl` & `chiefgram-3.5/compiler/api/source/main_api.tl`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/compiler/api/source/sys_msgs.tl` & `chiefgram-3.5/compiler/api/source/sys_msgs.tl`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/compiler/api/template/combinator.txt` & `chiefgram-3.5/compiler/api/template/combinator.txt`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/compiler/api/template/type.txt` & `chiefgram-3.5/compiler/api/template/type.txt`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/compiler/errors/__init__.py` & `chiefgram-3.5/compiler/errors/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/compiler/errors/compiler.py` & `chiefgram-3.5/compiler/errors/compiler.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/compiler/errors/sort.py` & `chiefgram-3.5/compiler/errors/sort.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/compiler/errors/source/400_BAD_REQUEST.tsv` & `chiefgram-3.5/compiler/errors/source/400_BAD_REQUEST.tsv`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/compiler/errors/source/401_UNAUTHORIZED.tsv` & `chiefgram-3.5/compiler/errors/source/401_UNAUTHORIZED.tsv`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/compiler/errors/source/403_FORBIDDEN.tsv` & `chiefgram-3.5/compiler/errors/source/403_FORBIDDEN.tsv`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/compiler/errors/source/406_NOT_ACCEPTABLE.tsv` & `chiefgram-3.5/compiler/errors/source/406_NOT_ACCEPTABLE.tsv`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/compiler/errors/source/500_INTERNAL_SERVER_ERROR.tsv` & `chiefgram-3.5/compiler/errors/source/500_INTERNAL_SERVER_ERROR.tsv`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/setup.py` & `chiefgram-3.5/setup.py`
...
### Comparing `chiefgram-2.5/tests/__init__.py` & `chiefgram-3.5/tests/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/tests/filters/__init__.py` & `chiefgram-3.5/tests/filters/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/tests/filters/test_command.py` & `chiefgram-3.5/tests/filters/test_command.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/tests/parser/__init__.py` & `chiefgram-3.5/tests/parser/__init__.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/tests/parser/test_html.py` & `chiefgram-3.5/tests/parser/test_html.py`

 * *Files identical despite different names*

### Comparing `chiefgram-2.5/tests/test_file_id.py` & `chiefgram-3.5/tests/test_file_id.py`
