# Comparing `tmp/composio_autogen-0.1.89.tar.gz` & `tmp/composio_autogen-0.1.90.tar.gz`
...
## Comparing `composio_autogen-0.1.89.tar` & `composio_autogen-0.1.90.tar`
...
### Comparing `composio_autogen-0.1.89/PKG-INFO` & `composio_autogen-0.1.90/PKG-INFO`
...
### Comparing `composio_autogen-0.1.89/README.md` & `composio_autogen-0.1.90/README.md`

 * *Files identical despite different names*

### Comparing `composio_autogen-0.1.89/composio_autogen/autogen_toolspec.py` & `composio_autogen-0.1.90/composio_autogen/autogen_toolspec.py`

 * *Files identical despite different names*

### Comparing `composio_autogen-0.1.89/composio_autogen.egg-info/PKG-INFO` & `composio_autogen-0.1.90/composio_autogen.egg-info/PKG-INFO`
...
### Comparing `composio_autogen-0.1.89/setup.py` & `composio_autogen-0.1.90/setup.py`
