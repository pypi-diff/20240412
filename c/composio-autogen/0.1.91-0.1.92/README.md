# Comparing `tmp/composio_autogen-0.1.91.tar.gz` & `tmp/composio_autogen-0.1.92.tar.gz`
...
## Comparing `composio_autogen-0.1.91.tar` & `composio_autogen-0.1.92.tar`
...
### Comparing `composio_autogen-0.1.91/PKG-INFO` & `composio_autogen-0.1.92/PKG-INFO`
...
### Comparing `composio_autogen-0.1.91/README.md` & `composio_autogen-0.1.92/README.md`

 * *Files identical despite different names*

### Comparing `composio_autogen-0.1.91/composio_autogen/autogen_toolspec.py` & `composio_autogen-0.1.92/composio_autogen/autogen_toolspec.py`

 * *Files identical despite different names*

### Comparing `composio_autogen-0.1.91/composio_autogen.egg-info/PKG-INFO` & `composio_autogen-0.1.92/composio_autogen.egg-info/PKG-INFO`
...
### Comparing `composio_autogen-0.1.91/setup.py` & `composio_autogen-0.1.92/setup.py`
