# Comparing `tmp/composio_autogen-0.1.96.tar.gz` & `tmp/composio_autogen-0.1.97.tar.gz`
...
## Comparing `composio_autogen-0.1.96.tar` & `composio_autogen-0.1.97.tar`
...
### Comparing `composio_autogen-0.1.96/PKG-INFO` & `composio_autogen-0.1.97/PKG-INFO`
...
### Comparing `composio_autogen-0.1.96/README.md` & `composio_autogen-0.1.97/README.md`

 * *Files identical despite different names*

### Comparing `composio_autogen-0.1.96/composio_autogen/autogen_toolspec.py` & `composio_autogen-0.1.97/composio_autogen/autogen_toolspec.py`

 * *Files identical despite different names*

### Comparing `composio_autogen-0.1.96/composio_autogen.egg-info/PKG-INFO` & `composio_autogen-0.1.97/composio_autogen.egg-info/PKG-INFO`
...
### Comparing `composio_autogen-0.1.96/setup.py` & `composio_autogen-0.1.97/setup.py`
