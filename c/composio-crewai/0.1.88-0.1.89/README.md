# Comparing `tmp/composio_crewai-0.1.88.tar.gz` & `tmp/composio_crewai-0.1.89.tar.gz`
...
## Comparing `composio_crewai-0.1.88.tar` & `composio_crewai-0.1.89.tar`
...
### Comparing `composio_crewai-0.1.88/PKG-INFO` & `composio_crewai-0.1.89/PKG-INFO`
...
### Comparing `composio_crewai-0.1.88/README.md` & `composio_crewai-0.1.89/README.md`

 * *Files identical despite different names*

### Comparing `composio_crewai-0.1.88/composio_crewai.egg-info/PKG-INFO` & `composio_crewai-0.1.89/composio_crewai.egg-info/PKG-INFO`
...
### Comparing `composio_crewai-0.1.88/setup.py` & `composio_crewai-0.1.89/setup.py`
