# Comparing `tmp/composio_crewai-0.1.91.tar.gz` & `tmp/composio_crewai-0.1.92.tar.gz`
...
## Comparing `composio_crewai-0.1.91.tar` & `composio_crewai-0.1.92.tar`
...
### Comparing `composio_crewai-0.1.91/PKG-INFO` & `composio_crewai-0.1.92/PKG-INFO`
...
### Comparing `composio_crewai-0.1.91/README.md` & `composio_crewai-0.1.92/README.md`

 * *Files identical despite different names*

### Comparing `composio_crewai-0.1.91/composio_crewai.egg-info/PKG-INFO` & `composio_crewai-0.1.92/composio_crewai.egg-info/PKG-INFO`
...
### Comparing `composio_crewai-0.1.91/setup.py` & `composio_crewai-0.1.92/setup.py`
