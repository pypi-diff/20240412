# Comparing `tmp/composio_crewai-0.1.97.tar.gz` & `tmp/composio_crewai-0.1.98.tar.gz`
...
## Comparing `composio_crewai-0.1.97.tar` & `composio_crewai-0.1.98.tar`
...
### Comparing `composio_crewai-0.1.97/PKG-INFO` & `composio_crewai-0.1.98/PKG-INFO`
...
### Comparing `composio_crewai-0.1.97/README.md` & `composio_crewai-0.1.98/README.md`

 * *Files identical despite different names*

### Comparing `composio_crewai-0.1.97/composio_crewai.egg-info/PKG-INFO` & `composio_crewai-0.1.98/composio_crewai.egg-info/PKG-INFO`
...
### Comparing `composio_crewai-0.1.97/setup.py` & `composio_crewai-0.1.98/setup.py`
