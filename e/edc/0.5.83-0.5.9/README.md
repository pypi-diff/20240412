# Comparing `tmp/edc-0.5.83.tar.gz` & `tmp/edc-0.5.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "edc-0.5.83.tar", last modified: Fri Apr 12 15:30:49 2024, max compression
+gzip compressed data, was "edc-0.5.9.tar", last modified: Thu Jul 20 02:51:26 2023, max compression
```

## Comparing `edc-0.5.83.tar` & `edc-0.5.9.tar`

### file list

```diff
@@ -1,82 +1,75 @@
-drwxr-xr-x   0 jw         (502) staff       (20)        0 2024-04-12 15:30:49.617775 edc-0.5.83/
--rw-r--r--   0 jw         (502) staff       (20)     1410 2023-04-18 18:48:47.000000 edc-0.5.83/.gitignore
--rw-r--r--   0 jw         (502) staff       (20)     1077 2024-04-08 13:56:04.000000 edc-0.5.83/.pre-commit-config.yaml
--rw-r--r--   0 jw         (502) staff       (20)      291 2023-04-18 18:48:47.000000 edc-0.5.83/.yamllint
--rw-r--r--   0 jw         (502) staff       (20)        0 2023-04-18 18:48:47.000000 edc-0.5.83/AUTHORS
--rw-r--r--   0 jw         (502) staff       (20)    66225 2024-04-12 15:30:32.000000 edc-0.5.83/CHANGES
--rw-r--r--   0 jw         (502) staff       (20)    35147 2021-07-06 12:52:00.000000 edc-0.5.83/LICENSE
--rw-r--r--   0 jw         (502) staff       (20)      151 2021-07-06 12:52:00.000000 edc-0.5.83/MANIFEST.in
--rw-r--r--   0 jw         (502) staff       (20)    44528 2024-04-12 15:30:49.617540 edc-0.5.83/PKG-INFO
--rw-r--r--   0 jw         (502) staff       (20)    40358 2024-04-08 13:56:04.000000 edc-0.5.83/README.rst
-drwxr-xr-x   0 jw         (502) staff       (20)        0 2024-04-12 15:30:49.562572 edc-0.5.83/bin/
-drwxr-xr-x   0 jw         (502) staff       (20)        0 2024-04-12 15:30:49.571426 edc-0.5.83/bin/nginx/
--rw-r--r--   0 jw         (502) staff       (20)      350 2023-04-18 18:48:47.000000 edc-0.5.83/bin/nginx/edc-sites.conf
--rw-r--r--   0 jw         (502) staff       (20)      706 2023-04-18 18:48:47.000000 edc-0.5.83/bin/nginx/edc-uat.conf
--rw-r--r--   0 jw         (502) staff       (20)      656 2023-04-18 18:48:47.000000 edc-0.5.83/bin/nginx/edc.conf
-drwxr-xr-x   0 jw         (502) staff       (20)        0 2024-04-12 15:30:49.573752 edc-0.5.83/bin/scripts/
--rw-r--r--   0 jw         (502) staff       (20)     2753 2023-04-18 18:48:47.000000 edc-0.5.83/bin/scripts/dev_repos.sh
--rw-r--r--   0 jw         (502) staff       (20)      276 2021-07-06 12:52:00.000000 edc-0.5.83/bin/scripts/list_db_files.sh
--rw-r--r--   0 jw         (502) staff       (20)      416 2021-07-06 12:52:00.000000 edc-0.5.83/bin/scripts/restore_db_file.sh
--rw-r--r--   0 jw         (502) staff       (20)     2408 2023-04-18 18:48:47.000000 edc-0.5.83/bin/scripts/update_edc.sh
-drwxr-xr-x   0 jw         (502) staff       (20)        0 2024-04-12 15:30:49.577376 edc-0.5.83/bin/systemd/
--rw-r--r--   0 jw         (502) staff       (20)      835 2021-07-06 12:52:00.000000 edc-0.5.83/bin/systemd/celery-uat.service
--rw-r--r--   0 jw         (502) staff       (20)      820 2021-07-06 12:52:00.000000 edc-0.5.83/bin/systemd/celery.service
--rw-r--r--   0 jw         (502) staff       (20)      501 2021-07-06 12:52:00.000000 edc-0.5.83/bin/systemd/celerybeat-uat.service
--rw-r--r--   0 jw         (502) staff       (20)      487 2021-07-06 12:52:00.000000 edc-0.5.83/bin/systemd/celerybeat.service
--rw-r--r--   0 jw         (502) staff       (20)      485 2021-07-06 12:52:00.000000 edc-0.5.83/bin/systemd/gunicorn-uat.service
--rw-r--r--   0 jw         (502) staff       (20)      121 2021-07-06 12:52:00.000000 edc-0.5.83/bin/systemd/gunicorn-uat.socket
--rw-r--r--   0 jw         (502) staff       (20)      474 2021-07-06 12:52:00.000000 edc-0.5.83/bin/systemd/gunicorn.service
--rw-r--r--   0 jw         (502) staff       (20)      111 2021-07-06 12:52:00.000000 edc-0.5.83/bin/systemd/gunicorn.socket
-drwxr-xr-x   0 jw         (502) staff       (20)        0 2024-04-12 15:30:49.592239 edc-0.5.83/docs/
--rw-r--r--   0 jw         (502) staff       (20)      634 2023-04-18 18:48:47.000000 edc-0.5.83/docs/Makefile
--rw-r--r--   0 jw         (502) staff       (20)    12978 2024-04-08 13:56:04.000000 edc-0.5.83/docs/README.rst
--rw-r--r--   0 jw         (502) staff       (20)    15486 2023-11-07 14:54:59.000000 edc-0.5.83/docs/backup.rst
--rw-r--r--   0 jw         (502) staff       (20)     5437 2023-04-27 10:01:42.000000 edc-0.5.83/docs/celery.rst
--rw-r--r--   0 jw         (502) staff       (20)     1531 2024-04-08 13:56:04.000000 edc-0.5.83/docs/conda.rst
--rw-r--r--   0 jw         (502) staff       (20)      975 2023-04-18 18:48:47.000000 edc-0.5.83/docs/conf.py
--rw-r--r--   0 jw         (502) staff       (20)     6596 2023-11-07 14:54:59.000000 edc-0.5.83/docs/configure_web_services.rst
--rw-r--r--   0 jw         (502) staff       (20)     3646 2023-04-18 18:48:47.000000 edc-0.5.83/docs/deploy_new_droplet.rst
--rw-r--r--   0 jw         (502) staff       (20)     9565 2023-09-20 18:22:32.000000 edc-0.5.83/docs/disaster_recovery.rst
--rw-r--r--   0 jw         (502) staff       (20)      163 2021-07-06 12:52:00.000000 edc-0.5.83/docs/dump_users.rst
--rw-r--r--   0 jw         (502) staff       (20)      845 2021-07-06 12:52:00.000000 edc-0.5.83/docs/exporting_encrypted_data.rst
--rw-r--r--   0 jw         (502) staff       (20)   258708 2023-04-18 18:48:47.000000 edc-0.5.83/docs/forms_reference.md
--rw-r--r--   0 jw         (502) staff       (20)      445 2023-04-18 18:48:47.000000 edc-0.5.83/docs/index.rst
--rw-r--r--   0 jw         (502) staff       (20)      643 2023-11-07 14:53:56.000000 edc-0.5.83/docs/landing_page.rst
--rw-r--r--   0 jw         (502) staff       (20)      765 2023-04-18 18:48:47.000000 edc-0.5.83/docs/make.bat
--rw-r--r--   0 jw         (502) staff       (20)     3928 2023-04-18 18:48:47.000000 edc-0.5.83/docs/prepare_database.rst
--rw-r--r--   0 jw         (502) staff       (20)     1211 2023-04-18 18:48:47.000000 edc-0.5.83/docs/printing.rst
--rw-r--r--   0 jw         (502) staff       (20)      187 2021-07-06 12:52:00.000000 edc-0.5.83/docs/redis.rst
--rw-r--r--   0 jw         (502) staff       (20)      766 2021-07-06 12:52:00.000000 edc-0.5.83/docs/update_deployment.rst
-drwxr-xr-x   0 jw         (502) staff       (20)        0 2024-04-12 15:30:49.616331 edc-0.5.83/edc.egg-info/
--rw-r--r--   0 jw         (502) staff       (20)    44528 2024-04-12 15:30:49.000000 edc-0.5.83/edc.egg-info/PKG-INFO
--rw-r--r--   0 jw         (502) staff       (20)     1719 2024-04-12 15:30:49.000000 edc-0.5.83/edc.egg-info/SOURCES.txt
--rw-r--r--   0 jw         (502) staff       (20)        1 2024-04-12 15:30:49.000000 edc-0.5.83/edc.egg-info/dependency_links.txt
--rw-r--r--   0 jw         (502) staff       (20)        1 2024-04-12 15:30:49.000000 edc-0.5.83/edc.egg-info/not-zip-safe
--rw-r--r--   0 jw         (502) staff       (20)     1957 2024-04-12 15:30:49.000000 edc-0.5.83/edc.egg-info/requires.txt
--rw-r--r--   0 jw         (502) staff       (20)        6 2024-04-12 15:30:49.000000 edc-0.5.83/edc.egg-info/top_level.txt
-drwxr-xr-x   0 jw         (502) staff       (20)        0 2024-04-12 15:30:49.605170 edc-0.5.83/image/
--rw-r--r--   0 jw         (502) staff       (20)    34744 2023-11-27 21:23:40.000000 edc-0.5.83/image/administration_appointment.png
--rw-r--r--   0 jw         (502) staff       (20)    14449 2023-11-27 21:23:40.000000 edc-0.5.83/image/administration_button.png
--rw-r--r--   0 jw         (502) staff       (20)     4335 2023-11-27 21:23:40.000000 edc-0.5.83/image/administration_icon.png
--rw-r--r--   0 jw         (502) staff       (20)   157606 2023-11-27 21:23:40.000000 edc-0.5.83/image/appointments.png
--rw-r--r--   0 jw         (502) staff       (20)   157606 2023-11-27 21:23:40.000000 edc-0.5.83/image/appointments_annotated_top.png
--rw-r--r--   0 jw         (502) staff       (20)    15845 2023-11-27 21:23:40.000000 edc-0.5.83/image/appointments_changelist.png
--rw-r--r--   0 jw         (502) staff       (20)     4708 2023-11-27 21:23:40.000000 edc-0.5.83/image/down_arrow.png
--rw-r--r--   0 jw         (502) staff       (20)   160721 2021-08-24 11:21:23.000000 edc-0.5.83/image/icon-pycharm.png
--rw-r--r--   0 jw         (502) staff       (20)      118 2023-10-06 16:11:05.000000 edc-0.5.83/pyproject.toml
-drwxr-xr-x   0 jw         (502) staff       (20)        0 2024-04-12 15:30:49.614581 edc-0.5.83/requirements.tests/
--rw-r--r--   0 jw         (502) staff       (20)       21 2023-04-18 18:48:47.000000 edc-0.5.83/requirements.tests/coverage.txt
--rw-r--r--   0 jw         (502) staff       (20)       14 2023-04-18 18:48:47.000000 edc-0.5.83/requirements.tests/docs.txt
--rw-r--r--   0 jw         (502) staff       (20)     1158 2024-04-08 13:56:04.000000 edc-0.5.83/requirements.tests/edc.txt
--rw-r--r--   0 jw         (502) staff       (20)     4027 2024-04-08 13:56:04.000000 edc-0.5.83/requirements.tests/edc_dev.txt
--rw-r--r--   0 jw         (502) staff       (20)       68 2021-07-06 12:52:00.000000 edc-0.5.83/requirements.tests/edc_offline.txt
--rw-r--r--   0 jw         (502) staff       (20)       55 2024-04-08 13:56:04.000000 edc-0.5.83/requirements.tests/lint.txt
--rw-r--r--   0 jw         (502) staff       (20)       11 2023-04-18 18:48:47.000000 edc-0.5.83/requirements.tests/mysql.txt
--rw-r--r--   0 jw         (502) staff       (20)       22 2021-07-06 12:52:00.000000 edc-0.5.83/requirements.tests/postgres.txt
--rw-r--r--   0 jw         (502) staff       (20)      159 2024-04-08 13:56:04.000000 edc-0.5.83/requirements.tests/test_utils.txt
--rw-r--r--   0 jw         (502) staff       (20)      238 2023-04-18 18:48:47.000000 edc-0.5.83/requirements.tests/third_party_dev.txt
--rw-r--r--   0 jw         (502) staff       (20)       50 2023-09-27 19:08:15.000000 edc-0.5.83/requirements.tests/tox.txt
--rw-r--r--   0 jw         (502) staff       (20)     2962 2024-04-12 15:30:49.618629 edc-0.5.83/setup.cfg
-drwxr-xr-x   0 jw         (502) staff       (20)        0 2024-04-12 15:30:49.615639 edc-0.5.83/utils/
--rw-r--r--   0 jw         (502) staff       (20)        0 2021-07-06 12:52:00.000000 edc-0.5.83/utils/__init__.py
--rw-r--r--   0 jw         (502) staff       (20)      721 2023-04-18 18:48:47.000000 edc-0.5.83/utils/get_edc_requirements.py
...
### Comparing `edc-0.5.83/.gitignore` & `edc-0.5.9/.gitignore`

 * *Files identical despite different names*

### Comparing `edc-0.5.83/.pre-commit-config.yaml` & `edc-0.5.9/.pre-commit-config.yaml`
...
### Comparing `edc-0.5.83/CHANGES` & `edc-0.5.9/CHANGES`
...
### Comparing `edc-0.5.83/LICENSE` & `edc-0.5.9/LICENSE`

 * *Files identical despite different names*

### Comparing `edc-0.5.83/README.rst` & `edc-0.5.9/PKG-INFO`
...
### Comparing `edc-0.5.83/bin/nginx/edc-uat.conf` & `edc-0.5.9/bin/nginx/edc-uat.conf`

 * *Files identical despite different names*

### Comparing `edc-0.5.83/bin/nginx/edc.conf` & `edc-0.5.9/bin/nginx/edc.conf`

 * *Files identical despite different names*

### Comparing `edc-0.5.83/bin/scripts/dev_repos.sh` & `edc-0.5.9/bin/scripts/dev_repos.sh`

 * *Files identical despite different names*

### Comparing `edc-0.5.83/bin/scripts/update_edc.sh` & `edc-0.5.9/bin/scripts/update_edc.sh`

 * *Files identical despite different names*

### Comparing `edc-0.5.83/bin/systemd/celery-uat.service` & `edc-0.5.9/bin/systemd/celery-uat.service`

 * *Files identical despite different names*

### Comparing `edc-0.5.83/bin/systemd/celery.service` & `edc-0.5.9/bin/systemd/celery.service`

 * *Files identical despite different names*

### Comparing `edc-0.5.83/docs/Makefile` & `edc-0.5.9/docs/Makefile`

 * *Files identical despite different names*

### Comparing `edc-0.5.83/docs/README.rst` & `edc-0.5.9/docs/README.rst`
...
### Comparing `edc-0.5.83/docs/celery.rst` & `edc-0.5.9/docs/celery.rst`

 * *Files identical despite different names*

### Comparing `edc-0.5.83/docs/conf.py` & `edc-0.5.9/docs/conf.py`

 * *Files identical despite different names*

### Comparing `edc-0.5.83/docs/configure_web_services.rst` & `edc-0.5.9/docs/configure_web_services.rst`
...
### Comparing `edc-0.5.83/docs/deploy_new_droplet.rst` & `edc-0.5.9/docs/deploy_new_droplet.rst`

 * *Files identical despite different names*

### Comparing `edc-0.5.83/docs/exporting_encrypted_data.rst` & `edc-0.5.9/docs/exporting_encrypted_data.rst`

 * *Files identical despite different names*

### Comparing `edc-0.5.83/docs/forms_reference.md` & `edc-0.5.9/docs/forms_reference.md`

 * *Files identical despite different names*

### Comparing `edc-0.5.83/docs/make.bat` & `edc-0.5.9/docs/make.bat`

 * *Files identical despite different names*

### Comparing `edc-0.5.83/docs/prepare_database.rst` & `edc-0.5.9/docs/prepare_database.rst`

 * *Files identical despite different names*

### Comparing `edc-0.5.83/docs/printing.rst` & `edc-0.5.9/docs/printing.rst`

 * *Files identical despite different names*

### Comparing `edc-0.5.83/docs/update_deployment.rst` & `edc-0.5.9/docs/update_deployment.rst`

 * *Files identical despite different names*

### Comparing `edc-0.5.83/edc.egg-info/SOURCES.txt` & `edc-0.5.9/edc.egg-info/SOURCES.txt`
...
### Comparing `edc-0.5.83/edc.egg-info/requires.txt` & `edc-0.5.9/edc.egg-info/requires.txt`
...
-edc-action-item==0.3.88
-edc-adherence==0.3.13
-edc-adverse-event==0.3.82
-edc-appconfig==0.1.8
...
### Comparing `edc-0.5.83/image/icon-pycharm.png` & `edc-0.5.9/image/icon-pycharm.png`

 * *Files identical despite different names*

### Comparing `edc-0.5.83/requirements.tests/edc.txt` & `edc-0.5.9/requirements.tests/edc.txt`
...
### Comparing `edc-0.5.83/requirements.tests/edc_dev.txt` & `edc-0.5.9/requirements.tests/edc_dev.txt`
...
### Comparing `edc-0.5.83/setup.cfg` & `edc-0.5.9/setup.cfg`
...
### Comparing `edc-0.5.83/utils/get_edc_requirements.py` & `edc-0.5.9/utils/get_edc_requirements.py`
