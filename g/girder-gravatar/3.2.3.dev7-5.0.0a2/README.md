# Comparing `tmp/girder-gravatar-3.2.3.dev7.tar.gz` & `tmp/girder-gravatar-5.0.0a2.tar.gz`
...
## Comparing `girder-gravatar-3.2.3.dev7.tar` & `girder-gravatar-5.0.0a2.tar`
...
### Comparing `girder-gravatar-3.2.3.dev7/PKG-INFO` & `girder-gravatar-5.0.0a2/PKG-INFO`
...
### Comparing `girder-gravatar-3.2.3.dev7/girder_gravatar/__init__.py` & `girder-gravatar-5.0.0a2/girder_gravatar/__init__.py`
...
### Comparing `girder-gravatar-3.2.3.dev7/girder_gravatar.egg-info/PKG-INFO` & `girder-gravatar-5.0.0a2/girder_gravatar.egg-info/PKG-INFO`
...
### Comparing `girder-gravatar-3.2.3.dev7/plugin_tests/gravatar_test.py` & `girder-gravatar-5.0.0a2/plugin_tests/gravatar_test.py`

 * *Files identical despite different names*

### Comparing `girder-gravatar-3.2.3.dev7/setup.py` & `girder-gravatar-5.0.0a2/setup.py`
