# Comparing `tmp/girder-ldap-3.2.3.dev7.tar.gz` & `tmp/girder-ldap-5.0.0a2.tar.gz`
...
## Comparing `girder-ldap-3.2.3.dev7.tar` & `girder-ldap-5.0.0a2.tar`
...
### Comparing `girder-ldap-3.2.3.dev7/PKG-INFO` & `girder-ldap-5.0.0a2/PKG-INFO`
...
### Comparing `girder-ldap-3.2.3.dev7/girder_ldap/__init__.py` & `girder-ldap-5.0.0a2/girder_ldap/__init__.py`
...
### Comparing `girder-ldap-3.2.3.dev7/girder_ldap/settings.py` & `girder-ldap-5.0.0a2/girder_ldap/settings.py`

 * *Files identical despite different names*

### Comparing `girder-ldap-3.2.3.dev7/girder_ldap.egg-info/PKG-INFO` & `girder-ldap-5.0.0a2/girder_ldap.egg-info/PKG-INFO`
...
### Comparing `girder-ldap-3.2.3.dev7/plugin_tests/ldap_test.py` & `girder-ldap-5.0.0a2/plugin_tests/ldap_test.py`

 * *Files identical despite different names*

### Comparing `girder-ldap-3.2.3.dev7/setup.py` & `girder-ldap-5.0.0a2/setup.py`
