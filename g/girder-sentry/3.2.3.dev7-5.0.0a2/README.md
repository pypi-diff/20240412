# Comparing `tmp/girder-sentry-3.2.3.dev7.tar.gz` & `tmp/girder-sentry-5.0.0a2.tar.gz`
...
## Comparing `girder-sentry-3.2.3.dev7.tar` & `girder-sentry-5.0.0a2.tar`
...
### Comparing `girder-sentry-3.2.3.dev7/PKG-INFO` & `girder-sentry-5.0.0a2/PKG-INFO`
...
### Comparing `girder-sentry-3.2.3.dev7/girder_sentry/rest.py` & `girder-sentry-5.0.0a2/girder_sentry/rest.py`

 * *Files identical despite different names*

### Comparing `girder-sentry-3.2.3.dev7/girder_sentry/settings.py` & `girder-sentry-5.0.0a2/girder_sentry/settings.py`

 * *Files identical despite different names*

### Comparing `girder-sentry-3.2.3.dev7/girder_sentry.egg-info/PKG-INFO` & `girder-sentry-5.0.0a2/girder_sentry.egg-info/PKG-INFO`
...
### Comparing `girder-sentry-3.2.3.dev7/setup.py` & `girder-sentry-5.0.0a2/setup.py`
