# Comparing `tmp/girder-user-quota-3.2.3.dev7.tar.gz` & `tmp/girder_user_quota-5a2.tar.gz`
...
## Comparing `girder-user-quota-3.2.3.dev7.tar` & `girder_user_quota-5a2.tar`
...
### Comparing `girder-user-quota-3.2.3.dev7/PKG-INFO` & `girder_user_quota-5a2/PKG-INFO`
...
### Comparing `girder-user-quota-3.2.3.dev7/girder_user_quota/quota.py` & `girder_user_quota-5a2/girder_user_quota/quota.py`
...
### Comparing `girder-user-quota-3.2.3.dev7/girder_user_quota/settings.py` & `girder_user_quota-5a2/girder_user_quota/settings.py`

 * *Files identical despite different names*

### Comparing `girder-user-quota-3.2.3.dev7/girder_user_quota.egg-info/PKG-INFO` & `girder_user_quota-5a2/girder_user_quota.egg-info/PKG-INFO`
...
### Comparing `girder-user-quota-3.2.3.dev7/plugin_tests/user_quota_test.py` & `girder_user_quota-5a2/plugin_tests/user_quota_test.py`
...
### Comparing `girder-user-quota-3.2.3.dev7/setup.py` & `girder_user_quota-5a2/setup.py`
