# Comparing `tmp/johnsnowlabs_for_databricks-5.3.4rc1.tar.gz` & `tmp/johnsnowlabs_for_databricks-5.3.4rc2.tar.gz`
...
### Comparing `johnsnowlabs_for_databricks-5.3.4rc1/.github/workflows/create_search_index.yml` & `johnsnowlabs_for_databricks-5.3.4rc2/.github/workflows/create_search_index.yml`
...
### Comparing `johnsnowlabs_for_databricks-5.3.4rc1/johnsnowlabs/utils/my_jsl_api.py` & `johnsnowlabs_for_databricks-5.3.4rc2/johnsnowlabs/utils/my_jsl_api.py`
...
### Comparing `johnsnowlabs_for_databricks-5.3.4rc1/setup_johnsnowlabs.py` & `johnsnowlabs_for_databricks-5.3.4rc2/setup_johnsnowlabs.py`
...
### Comparing `johnsnowlabs_for_databricks-5.3.4rc1/tests/backward_compat.py` & `johnsnowlabs_for_databricks-5.3.4rc2/tests/backward_compat.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs_for_databricks-5.3.4rc1/tests/databricks/db_infos_test.py` & `johnsnowlabs_for_databricks-5.3.4rc2/tests/databricks/db_infos_test.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs_for_databricks-5.3.4rc1/tests/databricks/db_test_utils.py` & `johnsnowlabs_for_databricks-5.3.4rc2/tests/databricks/db_test_utils.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs_for_databricks-5.3.4rc1/tests/databricks/endpoint_tests.py` & `johnsnowlabs_for_databricks-5.3.4rc2/tests/databricks/endpoint_tests.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs_for_databricks-5.3.4rc1/tests/databricks/hdfs_tests.py` & `johnsnowlabs_for_databricks-5.3.4rc2/tests/databricks/hdfs_tests.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs_for_databricks-5.3.4rc1/tests/databricks/install_tests.py` & `johnsnowlabs_for_databricks-5.3.4rc2/tests/databricks/install_tests.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs_for_databricks-5.3.4rc1/tests/databricks/parameterized_nb_example.ipynb` & `johnsnowlabs_for_databricks-5.3.4rc2/tests/databricks/parameterized_nb_example.ipynb`

 * *Files identical despite different names*

### Comparing `johnsnowlabs_for_databricks-5.3.4rc1/tests/databricks/sample.ipynb` & `johnsnowlabs_for_databricks-5.3.4rc2/tests/databricks/sample.ipynb`

 * *Files identical despite different names*

### Comparing `johnsnowlabs_for_databricks-5.3.4rc1/tests/databricks/submit_tests.py` & `johnsnowlabs_for_databricks-5.3.4rc2/tests/databricks/submit_tests.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs_for_databricks-5.3.4rc1/tests/file_models.py` & `johnsnowlabs_for_databricks-5.3.4rc2/tests/file_models.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs_for_databricks-5.3.4rc1/tests/install.py` & `johnsnowlabs_for_databricks-5.3.4rc2/tests/install.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs_for_databricks-5.3.4rc1/tests/jsl_dependency_resolver.py` & `johnsnowlabs_for_databricks-5.3.4rc2/tests/jsl_dependency_resolver.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs_for_databricks-5.3.4rc1/tests/jsl_secrets.py` & `johnsnowlabs_for_databricks-5.3.4rc2/tests/jsl_secrets.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs_for_databricks-5.3.4rc1/tests/llm_frameworks/test_haystack.py` & `johnsnowlabs_for_databricks-5.3.4rc2/tests/llm_frameworks/test_haystack.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs_for_databricks-5.3.4rc1/tests/llm_frameworks/test_langchain.py` & `johnsnowlabs_for_databricks-5.3.4rc2/tests/llm_frameworks/test_langchain.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs_for_databricks-5.3.4rc1/tests/markdown_tests.py` & `johnsnowlabs_for_databricks-5.3.4rc2/tests/markdown_tests.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs_for_databricks-5.3.4rc1/tests/notebook_tests.py` & `johnsnowlabs_for_databricks-5.3.4rc2/tests/notebook_tests.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs_for_databricks-5.3.4rc1/tests/spark_session.py` & `johnsnowlabs_for_databricks-5.3.4rc2/tests/spark_session.py`

 * *Files identical despite different names*

### Comparing `johnsnowlabs_for_databricks-5.3.4rc1/tests/venv_wrapper_tests.py` & `johnsnowlabs_for_databricks-5.3.4rc2/tests/venv_wrapper_tests.py`
