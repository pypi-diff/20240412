# Comparing `tmp/mainshortcuts-1.6.72.tar.gz` & `tmp/mainshortcuts-1.6.73.tar.gz`
...
### Comparing `mainshortcuts-1.6.72/src/MainShortcuts/list.py` & `mainshortcuts-1.6.73/src/MainShortcuts/list.py`
