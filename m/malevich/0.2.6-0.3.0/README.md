# Comparing `tmp/malevich-0.2.6.tar.gz` & `tmp/malevich-0.3.0.tar.gz`
...
## Comparing `malevich-0.2.6.tar` & `malevich-0.3.0.tar`
...
### Comparing `malevich-0.2.6/.github/workflows/docs.yaml` & `malevich-0.3.0/.github/workflows/docs.yaml`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/.github/workflows/pypi.yaml` & `malevich-0.3.0/.github/workflows/pypi.yaml`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/LICENSE` & `malevich-0.3.0/LICENSE`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/PKG-INFO` & `malevich-0.3.0/PKG-INFO`
...
### Comparing `malevich-0.2.6/README.md` & `malevich-0.3.0/README.md`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/__init__.py` & `malevich-0.3.0/malevich/__init__.py`
...
### Comparing `malevich-0.2.6/malevich/_autoflow/flow.py` & `malevich-0.3.0/malevich/_autoflow/flow.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_autoflow/function.py` & `malevich-0.3.0/malevich/_autoflow/function.py`
...
### Comparing `malevich-0.2.6/malevich/_autoflow/tracer.py` & `malevich-0.3.0/malevich/_autoflow/tracer.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_autoflow/tree.py` & `malevich-0.3.0/malevich/_autoflow/tree.py`
...
### Comparing `malevich-0.2.6/malevich/_cli/ci.py` & `malevich-0.3.0/malevich/_cli/ci.py`
...
### Comparing `malevich-0.2.6/malevich/_cli/core/endpoints.py` & `malevich-0.3.0/malevich/_cli/core/endpoints.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_cli/dev/dev.py` & `malevich-0.3.0/malevich/_cli/dev/dev.py`
...
### Comparing `malevich-0.2.6/malevich/_cli/flow.py` & `malevich-0.3.0/malevich/_cli/flow.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_cli/install.py` & `malevich-0.3.0/malevich/_cli/install.py`
...
### Comparing `malevich-0.2.6/malevich/_cli/list.py` & `malevich-0.3.0/malevich/_cli/list.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_cli/manifest.py` & `malevich-0.3.0/malevich/_cli/manifest.py`
...
### Comparing `malevich-0.2.6/malevich/_cli/misc/manifest_to_env.py` & `malevich-0.3.0/malevich/_cli/misc/manifest_to_env.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_cli/new.py` & `malevich-0.3.0/malevich/_cli/new.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_cli/prefs.py` & `malevich-0.3.0/malevich/_cli/prefs.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_cli/remove.py` & `malevich-0.3.0/malevich/_cli/remove.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_cli/restore.py` & `malevich-0.3.0/malevich/_cli/restore.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_cli/space/init.py` & `malevich-0.3.0/malevich/_cli/space/init.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_cli/space/login.py` & `malevich-0.3.0/malevich/_cli/space/login.py`
...
### Comparing `malevich-0.2.6/malevich/_cli/use.py` & `malevich-0.3.0/malevich/_cli/use.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_core/ops.py` & `malevich-0.3.0/malevich/_core/ops.py`
...
### Comparing `malevich-0.2.6/malevich/_core/scan.py` & `malevich-0.3.0/malevich/_core/scan.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_meta/asset.py` & `malevich-0.3.0/malevich/_meta/asset.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_meta/collection.py` & `malevich-0.3.0/malevich/_meta/collection.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_meta/decor.py` & `malevich-0.3.0/malevich/_meta/decor.py`
...
### Comparing `malevich-0.2.6/malevich/_meta/flow.py` & `malevich-0.3.0/malevich/_meta/flow.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_meta/run.py` & `malevich-0.3.0/malevich/_meta/run.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_templates/Dockerfile.app` & `malevich-0.3.0/malevich/_templates/Dockerfile.app`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_templates/README.app.md` & `malevich-0.3.0/malevich/_templates/README.app.md`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_templates/flow.py.txt` & `malevich-0.3.0/malevich/_templates/flow.py.txt`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_templates/processor.py.txt` & `malevich-0.3.0/malevich/_templates/processor.py.txt`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_utility/args.py` & `malevich-0.3.0/malevich/_utility/args.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_utility/cache/manager.py` & `malevich-0.3.0/malevich/_utility/cache/manager.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_utility/ci/functions.py` & `malevich-0.3.0/malevich/_utility/ci/functions.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_utility/ci/github.py` & `malevich-0.3.0/malevich/_utility/ci/github.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_utility/ci/templates/malevich-ci-manual.yml` & `malevich-0.3.0/malevich/_utility/ci/templates/malevich-ci-manual.yml`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_utility/ci/templates/malevich-ci.yml` & `malevich-0.3.0/malevich/_utility/ci/templates/malevich-ci.yml`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_utility/dicts.py` & `malevich-0.3.0/malevich/_utility/dicts.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_utility/git/clone.py` & `malevich-0.3.0/malevich/_utility/git/clone.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_utility/logging.py` & `malevich-0.3.0/malevich/_utility/logging.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_utility/package.py` & `malevich-0.3.0/malevich/_utility/package.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_utility/registry.py` & `malevich-0.3.0/malevich/_utility/registry.py`
...
### Comparing `malevich-0.2.6/malevich/_utility/scan.py` & `malevich-0.3.0/malevich/_utility/scan.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_utility/stub.py` & `malevich-0.3.0/malevich/_utility/stub.py`
...
### Comparing `malevich-0.2.6/malevich/_utility/summary/abstract.py` & `malevich-0.3.0/malevich/_utility/summary/abstract.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/_utility/summary/time.py` & `malevich-0.3.0/malevich/_utility/summary/time.py`
...
### Comparing `malevich-0.2.6/malevich/_utility/tree.py` & `malevich-0.3.0/malevich/_utility/tree.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/annotations.py` & `malevich-0.3.0/malevich/annotations.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/cli.py` & `malevich-0.3.0/malevich/cli.py`
...
### Comparing `malevich-0.2.6/malevich/constants.py` & `malevich-0.3.0/malevich/constants.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/help.py` & `malevich-0.3.0/malevich/help.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/install/image.py` & `malevich-0.3.0/malevich/install/image.py`
...
### Comparing `malevich-0.2.6/malevich/install/installer.py` & `malevich-0.3.0/malevich/install/installer.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/install/stub.py` & `malevich-0.3.0/malevich/install/stub.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/interpreter/abstract.py` & `malevich-0.3.0/malevich/interpreter/abstract.py`
...
### Comparing `malevich-0.2.6/malevich/interpreter/core.py` & `malevich-0.3.0/malevich/interpreter/core.py`
...
### Comparing `malevich-0.2.6/malevich/interpreter/space.py` & `malevich-0.3.0/malevich/interpreter/space.py`
...
### Comparing `malevich-0.2.6/malevich/manifest.py` & `malevich-0.3.0/malevich/manifest.py`
...
### Comparing `malevich-0.2.6/malevich/models/argument.py` & `malevich-0.3.0/malevich/models/argument.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/models/collection.py` & `malevich-0.3.0/malevich/models/collection.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/models/dependency.py` & `malevich-0.3.0/malevich/models/dependency.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/models/flow_function.py` & `malevich-0.3.0/malevich/models/flow_function.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/models/injections.py` & `malevich-0.3.0/malevich/models/injections.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/models/installers/compat.py` & `malevich-0.3.0/malevich/models/installers/compat.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/models/installers/image.py` & `malevich-0.3.0/malevich/models/installers/image.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/models/installers/space.py` & `malevich-0.3.0/malevich/models/installers/space.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/models/manifest.py` & `malevich-0.3.0/malevich/models/manifest.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/models/nodes/asset.py` & `malevich-0.3.0/malevich/models/nodes/asset.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/models/nodes/base.py` & `malevich-0.3.0/malevich/models/nodes/base.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/models/nodes/collection.py` & `malevich-0.3.0/malevich/models/nodes/collection.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/models/nodes/operation.py` & `malevich-0.3.0/malevich/models/nodes/operation.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/models/nodes/tree.py` & `malevich-0.3.0/malevich/models/nodes/tree.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/models/preferences.py` & `malevich-0.3.0/malevich/models/preferences.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/models/registry/core_entry.py` & `malevich-0.3.0/malevich/models/registry/core_entry.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/models/results/base.py` & `malevich-0.3.0/malevich/models/results/base.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/models/results/core/result.py` & `malevich-0.3.0/malevich/models/results/core/result.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/models/results/space/collection.py` & `malevich-0.3.0/malevich/models/results/space/collection.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/models/state/core.py` & `malevich-0.3.0/malevich/models/state/core.py`
...
### Comparing `malevich-0.2.6/malevich/models/state/space.py` & `malevich-0.3.0/malevich/models/state/space.py`
...
### Comparing `malevich-0.2.6/malevich/models/task/base.py` & `malevich-0.3.0/malevich/models/task/base.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/models/task/interpreted/core.py` & `malevich-0.3.0/malevich/models/task/interpreted/core.py`
...
### Comparing `malevich-0.2.6/malevich/models/task/interpreted/space.py` & `malevich-0.3.0/malevich/models/task/interpreted/space.py`
...
### Comparing `malevich-0.2.6/malevich/models/task/promised.py` & `malevich-0.3.0/malevich/models/task/promised.py`
...
### Comparing `malevich-0.2.6/malevich/models/task.py` & `malevich-0.3.0/malevich/models/task.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/path.py` & `malevich-0.3.0/malevich/path.py`
...
### Comparing `malevich-0.2.6/malevich/runners/base.py` & `malevich-0.3.0/malevich/runners/base.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/square/df.py` & `malevich-0.3.0/malevich/square/df.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/square/jls.py` & `malevich-0.3.0/malevich/square/jls.py`

 * *Files identical despite different names*

### Comparing `malevich-0.2.6/malevich/square/utils.py` & `malevich-0.3.0/malevich/square/utils.py`
...
### Comparing `malevich-0.2.6/malevich/testing/env.py` & `malevich-0.3.0/malevich/testing/env.py`
...
### Comparing `malevich-0.2.6/malevich/testing/suite.py` & `malevich-0.3.0/malevich/testing/suite.py`
...
### Comparing `malevich-0.2.6/malevich.egg-info/PKG-INFO` & `malevich-0.3.0/malevich.egg-info/PKG-INFO`
...
### Comparing `malevich-0.2.6/malevich.egg-info/SOURCES.txt` & `malevich-0.3.0/malevich.egg-info/SOURCES.txt`
