# Comparing `tmp/sshpyk-0.10.tar.gz` & `tmp/sshpyk-0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "sshpyk-0.10.tar", last modified: Thu Apr 11 22:39:47 2024, max compression
+gzip compressed data, was "sshpyk-0.9.tar", last modified: Thu Apr 11 22:23:11 2024, max compression
```

## Comparing `sshpyk-0.10.tar` & `sshpyk-0.9.tar`

### file list

```diff
@@ -1,8 +1,8 @@
--rw-r--r--   0        0        0     1516 2024-04-11 22:39:27.461199 sshpyk-0.10/LICENSE
--rw-r--r--   0        0        0     8822 2024-04-11 22:39:27.461199 sshpyk-0.10/README.rst
--rw-r--r--   0        0        0      537 2024-04-11 22:39:27.461199 sshpyk-0.10/pyproject.toml
--rw-r--r--   0        0        0     3011 2024-04-11 22:39:27.461199 sshpyk-0.10/sshpyk/__init__.py
--rw-r--r--   0        0        0     4521 2024-04-11 22:39:27.461199 sshpyk-0.10/sshpyk/__main__.py
--rw-r--r--   0        0        0     1762 2024-04-11 22:39:27.461199 sshpyk-0.10/sshpyk/kernel/add.py
--rw-r--r--   0        0        0     4972 2024-04-11 22:39:27.461199 sshpyk-0.10/sshpyk/kernel/ls.py
--rw-r--r--   0        0        0     9056 1970-01-01 00:00:00.000000 sshpyk-0.10/PKG-INFO
...
### Comparing `sshpyk-0.10/LICENSE` & `sshpyk-0.9/LICENSE`

 * *Files identical despite different names*

### Comparing `sshpyk-0.10/README.rst` & `sshpyk-0.9/README.rst`
...
### Comparing `sshpyk-0.10/pyproject.toml` & `sshpyk-0.9/pyproject.toml`
...
### Comparing `sshpyk-0.10/sshpyk/__init__.py` & `sshpyk-0.9/sshpyk/__init__.py`

 * *Files identical despite different names*

### Comparing `sshpyk-0.10/sshpyk/__main__.py` & `sshpyk-0.9/sshpyk/__main__.py`

 * *Files identical despite different names*

### Comparing `sshpyk-0.10/sshpyk/kernel/add.py` & `sshpyk-0.9/sshpyk/kernel/add.py`

 * *Files identical despite different names*

### Comparing `sshpyk-0.10/sshpyk/kernel/ls.py` & `sshpyk-0.9/sshpyk/kernel/ls.py`

 * *Files identical despite different names*

### Comparing `sshpyk-0.10/PKG-INFO` & `sshpyk-0.9/PKG-INFO`
